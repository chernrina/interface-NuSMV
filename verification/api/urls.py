...
from .views import UserViewSet, ProjectViewSet, ProjectsViewSet, getProjectViewSet, UserIdViewSet, parse_smv_file, launch, getVisualization, create_smv_file
...
urlpatterns = [
	...
	path('visualization', getVisualization, name='visualization'),
